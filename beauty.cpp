...
Beauty::Beauty(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Beauty)
{
    ui->setupUi(this);
    QStringList titles;
    setWindowTitle("Barber & Salony Urody");
    ui->tableWidget->setColumnCount(3);
    titles << "Data" << "Tytuł" << "Kwota";
    ui->tableWidget->setHorizontalHeaderLabels(titles);
}

void Beauty::on_pushButton_clicked()
{
    int result;
    QString date;
    QString title;
...
void Beauty::on_pushButton_2_clicked()
{
    ui->lineEdit->setText(QString::number(Beauty::Sum()));

    QFile file("beauty_data.json");
...
void Beauty::on_pushButton_3_clicked()
{
...
//        o << "\\end{figure}" << "\n";
        ...
        system("pdflatex beauty_pdf.tex");
        system("evince beauty_pdf.pdf&");
}
}
